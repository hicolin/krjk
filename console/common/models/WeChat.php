...
class WeChat extends Model
{
    ...
    public function init()
    {
        ...
        $this->_appid = 'wx9af3f5741ade6ccf';
        $this->_appsecret = 'a044e8dfe53da56e48360e74c139afe7';
        $this->_token = 'www';
        $this->_appkey = '';
    }
    ...
    public function responseMsg(){
        ...
        //touch('./111.txt') ;   
        //file_put_contents('./123c.txt', $data ) ;  
    ...
    public function createImg1($tel='',$type=1,$poster_path='',$qrcode_path="./qrcode_temp/"){
        ...
        if(!$qrcode){
           ...
           // return 33;
            ...
            imagettftext($dst_qr,18,0,226,550,$rqys,$font,$nickname); //数字参数1 字体的大小；  数字参数2  字体水平 ；数字参数3：数字越小往左
            // imagettftext($dst_qr,18,0,260,1080,$rqys,$font,'长按二维码加入');
            // imagecopy($dst_qr,$thumb, 100, 840, 0, 0, 200, 200); 
            imagecopy($dst_qr,$thumb, 228,600, 0, 0, 200, 200); //参数1 数字越大水平往右移   参数2 数字越大二维码越向下
            imagecopy($dst_qr,$pic, 175, 770, 0, 0, 46, 46);
            //销毁
            //imagedestroy($thumb);
            //imagedestroy($head_img);
    ...
    public function createImg2($tel='',$type=1,$poster_path='',$qrcode_path="./qrcode_temp2/"){
        ...
        if(!$qrcode){
            ...
            file_put_contents('code1.txt', $code_url2);
            $filename_code = './uploads/img/qrcode/'.$tel.'_code2.jpg';
            PublicController::qrCode($code_url2,$filename_code);
            $qr_code = file_get_contents($filename_code);
            ob_end_clean();
            $head_img = $this->getImg($head_url);
           ...
           // return 33;
            //写的文字用到的字体。字体最好用系统有得，否则会包charmap的错，这是黑体
            //$font = "simhei.ttf";   //写的文字用到的字体。字体最好用系统有得，否则会包charmap的错，这是黑体
            imagettftext($dst_qr,25,0,260,650,$rqys,$font,$nickname);
            //imagettftext($dst_qr,18,0,260,1080,$rqys,$font,'长按二维码加入');
            imagecopy($dst_qr,$thumb, 240, 680, 0, 0, 200, 200);
