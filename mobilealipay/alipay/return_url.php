...
file_put_contents('cs1.txt',$result);
/* 实际验证过程建议商户添加以下校验。
...
*/
 ...
 echo '<div style="margin: 100px auto;width: 60%;font-size: 2.5rem;text-align: center">正在跳转，请稍后。。。。。</div>';
if($result) {//验证成功
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//请在这里加上商户的业务逻辑程序代码
    ...
    //     }
    header('Location: http://'.$_SERVER['HTTP_HOST'].'/index.php?r=pay%2Falipay'.'&order_id='.$out_trade_no);
