...
//file_put_contents('./66666.txt', '/213');
...
file_put_contents('./555.txt', $result) ;
...
*/
 ...
 file_put_contents('66666.txt', $order_sn);
if($result) {//验证成功
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//请在这里加上商户的业务逻辑程序代
...
//			    file_put_contents('66666.txt', $order_sn);
			...
			if($row){
                file_put_contents('./6668.txt', date("H:i:s"));
                // fy_status = 0 解决支付宝支付成功后，用户不返回商户，不会进行分佣的问题
                $sql1="update admin_buy_agent set status=1,fy_status=0 where order_sn='$order_sn'";
