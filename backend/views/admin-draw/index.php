...
<th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" ><?=$modelLabel->getAttributeLabel("pic")?></th>
<th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" ><?=$modelLabel->getAttributeLabel("name")?></th>
<th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" ><?=$modelLabel->getAttributeLabel("url")?></th>
...
?>
                                <tr id="rowid_$list->id">
                                    <td><label><input type="checkbox" value="<?=$list->id?>"></label></td>
                                                                                       ...
                                                                                       <td> <img id="thumb" width="80" height="60" src="<?=$list->pic?>"></td>
                                                                                        <td><?=$list->name?></td>
                                                                                        <td><?=$list->url?></td>

                                                                                        <td>
                                                                                            <?php /* if($list->permission==1){ */?><!--

                                                                                            <a class="btn btn-primary btn-sm" ff='<?/*=$list->permission*/?>' id='see-<?/*=$list->id*/?>' onclick="see('<?/*=$list->id*/?>')">
                                                                                           ...
                                                                                           <?php /*}else{*/?>
                                                                                            ...
                                                                                            <a class="btn btn-danger btn-sm" ff='<?/*=$list->permission*/?>' id='see-<?/*=$list->id*/?>' onclick="see('<?/*=$list->id*/?>')">
                                                                                     
                                                                                                <span class='glyphicon glyphicon-remove'>不可见</span>
...
<script>
    ...
    function see(id){
        ...
        $.ajax({
            type:'GET',
            data:{"id":id,"val":val},
            url:"<?=Url::toRoute($this->context->id.'/changesee')?>",
            success:function(data){
                if(data==1){
