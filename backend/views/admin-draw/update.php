...
<section class="content">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-8">
        <img class="change_img" id="thumb" width="120" height="136" src="<?=$model->pic?:'/backend/web/images/default.jpg'?>">
...
<div class="form-group">
   ...
   <div class="col-sm-8">
   <?php echo $form->field($model,'name')->textInput(["class"=>"form-control","value"=>PublicController::filter_decode($model->name),"placeholder"=>$modelLabel->getAttributeLabel("name"),"id"=>'name']) ?>
   </div>
</div>
 <div class="clear"></div>
...
<div class="form-group">
   ...
   <div class="col-sm-8">
   <?php echo $form->field($model,'url')->textInput(["class"=>"form-control","placeholder"=>$modelLabel->getAttributeLabel("url"),"id"=>'url']) ?>
   </div>
</div>
 <div class="clear"></div>
