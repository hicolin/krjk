                ...
                <div class="box-header">
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 150px;" >
                            <a id="create_btn" href="<?=Url::toRoute([$this->context->id.'/create'])?>" class="btn btn-xs btn-primary" style="display: none;">添&nbsp;&emsp;加</a>
                            &nbsp;&nbsp;
                    ...
                    <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <span style="margin-left: 5px;color:rgb(60, 141, 188)">* 此表的会员价格需要与 加入会员/产品列表 中会员价格相同</span>
                                <table id="data_table" class="table table-bordered table-striped dataTable" role="grid"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                            aria-sort="ascending"><?= $modelLabel->getAttributeLabel("grade_name") ?></th>
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                            aria-sort="ascending"><?= $modelLabel->getAttributeLabel("price") ?></th>
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
