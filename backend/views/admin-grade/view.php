                ...
                <div class="box-header">
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <a id="create_btn" href="<?=Url::toRoute([$this->context->id.'/index'])?>" class="btn btn-xs btn-primary">admin-grades列表</a>
                        </div>
                    </div>
                </div>
                <!-- /.box-header -->
...
<div class="form-group">
   ...
   <div class="col-sm-8">
<div class="form-control" style="height: auto;min-height: 34px;"><?=$model->grade_name?></div>   </div>
</div>
 <div class="clear"></div>
<div class="form-group">
