                    ...
                    <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <a href="<?=Url::toRoute(['public/download-file','file'=>'/backend/web/excel/count.csv'])?>"><button id="excel_btn" type="button" class="btn btn-xs btn-primary">模板下载</button></a>
                                <table id="data_table" class="table table-bordered table-striped dataTable" role="grid"
                                    ...
                                    foreach ($model as $list) {
                                        ...
                                        <tr id="rowid_$list->id">
                                            ...
                                            <td>
                                                <span class="glyphicon <?= $list->is_match?'glyphicon-ok':'glyphicon-remove' ?> btn btn-xs btn-primary"></span>
                                            </td>
...
<script type="text/javascript">
    ...
    function UploadFile()
    {
        ...
        //服务器端的路径
        var FileController = "<?=Url::toRoute('/public/excel')?>";
