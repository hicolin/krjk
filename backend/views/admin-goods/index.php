                    ...
                    <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <span style="margin-left: 5px;color:rgb(60, 141, 188)">* 此表的会员价格需要与 会员管理/分类列表 中会员价格相同</span>
                                <table id="data_table" class="table table-bordered table-striped dataTable" role="grid"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                            aria-sort="ascending"><?= $modelLabel->getAttributeLabel("sold_num") ?></th>
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                    ...
                                    foreach ($model as $list) {
                                        ...
                                        <tr id="rowid_$list->id">
                                            ...
                                            <td><?= $list->price ?></td>
                                            <td><?= $list->sold_num ?></td>
                                            <td><?= date('Y-m-d H:i:s', $list->create_time);
                                                ?></td>
                                            <td class="center">
