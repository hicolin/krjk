                ...
                <div class="box-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group" style="margin-left: 15px;width: 1000px;">
                                购买产品金牌会员返佣
                        ...
                        <div class="form-group">
                            <label for="pic"
                                   class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("share_pic") ?>
                                        <p style="color: red">*建议上传750*320</p>
                                   </label>
                            <div class="col-sm-8">
                                <img src="<?=$model->share_pic?>" width="200" >
                                <?= $form->field($model, 'share_pic')->fileInput() ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="sub_pic"
                                   class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("sub_pic") ?>
                                        <p style="color: red">*建议上传640*1135</p>
                                   </label>
                            <div class="col-sm-8">
                                <img src="<?=$model->sub_pic?>" width="200" height="100" >
                        ...
                        <input type="hidden" id="oldsubpic" value="<?=$model->sub_pic?>"> 
