                        ...
                        <div class="col-sm-12">
                            ...
                            <table id="data_table" class="table table-bordered table-striped dataTable" role="grid"
                                ...
                                <tr role="row">
                                    ...
                                    <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                        aria-sort="ascending"><?= $modelLabel->getAttributeLabel("img") ?></th>
<!--                                    <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"-->
<!--                                        aria-sort="ascending">--><?//= $modelLabel->getAttributeLabel("grade") ?><!--</th>-->
                                    <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                        aria-sort="ascending"><?= $modelLabel->getAttributeLabel("remark") ?></th>
                                    <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                        aria-sort="ascending" width="200"><?= $modelLabel->getAttributeLabel("links") ?></th>
                                    <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                ...
                                foreach ($model as $list) {
                                    ...
                                    <tr id="rowid_$list->id">
                                        ...
                                        <td> <?= PublicController::subStr($list['remark'], 8) ?></td>
                                        <td><?= $list->links ?></td>
                                        <td class="center">
