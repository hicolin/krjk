...
<th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" ><?=$modelLabel->getAttributeLabel("pay_name")?></th>
<th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" ><?=$modelLabel->getAttributeLabel("is_open")?></th>
<th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" ><?=$modelLabel->getAttributeLabel("pay_site")?></th>
<th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" ><?=$modelLabel->getAttributeLabel("created_time")?></th>
...
?>
                                <tr id="rowid_$list->id">
                                    <td><label><input type="checkbox" value="<?=$list->id?>"></label></td>
                                            ...
                                            <?php
                                            if($list->is_open==0){
                                                echo "<a class='btn btn-primary btn-sm' href=".Url::toRoute([$this->context->id.'/status','id'=>$list->id,'type'=>$list->is_open])." >
                                                <span class='glyphicon glyphicon-remove'>关闭</span></a>";
                                            }elseif($list->is_open==1){
                                                echo "<a class='btn btn-danger btn-sm' href=".Url::toRoute([$this->context->id.'/status','id'=>$list->id,'type'=>$list->is_open])." > <span class='glyphicon glyphicon-ok'>开启</span></a>";
                                            }
                                            ?> 
                                            </td>
                                                                                    <!--     <?=$list->is_open?></td> -->
