...
<section class="content">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-8">
        <img class="change_img" id="thumb" width="120" height="136" src="<?=$model->img?:'/backend/web/images/default.jpg'?>">
...
<div class="form-group">
   ...
   <div class="col-sm-8">
   <?php echo $form->field($model,'name')->textInput(["class"=>"form-control","placeholder"=>$modelLabel->getAttributeLabel("name"),"value"=>PublicController::filter_decode($model->name),"id"=>'name']) ?>
   </div>
</div>
 <div class="clear"></div>
...
<div class="form-group" style="display: none;">
   ...
   <div class="col-sm-8">
   <?php echo $form->field($model,'create_time')->textInput(["value"=>time(),"class"=>"form-control","placeholder"=>$modelLabel->getAttributeLabel("create_tim"),"id"=>'create_time']) ?>
   </div>
</div>
 <div class="clear"></div>
                        <div class="form-group">
