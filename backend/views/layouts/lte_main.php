...
$this->title = \common\controllers\PublicController::getSysInfo(25);
...
<?php if (Yii::$app->session->hasFlash('success')): ?>
    <script>
        var msg = '<?= Yii::$app->session->getFlash('success') ?>';
...
<?php if (Yii::$app->session->hasFlash('error')): ?>
    <script>
        var msg = '<?= Yii::$app->session->getFlash('error') ?>';
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?=Url::toRoute('site/index')?>" class="logo">
      ...
      <span class="logo-lg"><b><?=\common\controllers\PublicController::getSysInfo(25)?></b>后台系统</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                <!-- User Account: style can be found in dropdown.less -->
              <li class="">
                <a target="_blank" href="javascript:;" onclick="updateMenu()">
                  <span class="hidden-xs">更新菜单&nbsp;&nbsp;</span>
                </a>
              </li>
                <li class="">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2015-<?=date('Y')?><?=\common\controllers\PublicController::getSysInfo(25)?>.</strong> All rights
    reserved. <a class="protocol" style="margin-left: 10px" href="javascript:;">软件使用声明及免责声明</a>
  </footer>
...
<script>
  ...
  function updateMenu() {
      layer.load(2);
      $.ajax({
          url:"http://xed.xinedai0308.com/index.php?r=index%2Fupdate-menu",
          type:"get",
          dataType:"text",
