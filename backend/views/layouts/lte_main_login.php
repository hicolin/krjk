...
<head>
  ...
  <title><?=\common\controllers\PublicController::getSysInfo(25)?></title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?=Url::base()?>/backend/web/plugins/iCheck/square/blue.css">
...
<!-- iCheck -->
<script src="<?=Url::base()?>/backend/web/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
