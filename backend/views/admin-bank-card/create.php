            ...
            <div class="box">
                ...
                <div class="box-body">
                    <?php $form = ActiveForm::begin([
                        ...
                        'action' => Url::toRoute('admin-bank-card/create'),
                        'options' => [
                    ...
                    <div class="tab-content">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <img class="change_img" img_type="logo" id="thumb_logo" width="80" height="90" src="/backend/web/images/default.jpg">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <?php echo $form->field($model, 'beizhu')->textInput(["class" => "form-control", "placeholder" => $modelLabel->getAttributeLabel("beizhu"), "id" => 'beizhu']) ?>
                            </div>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <img class="change_img" id="thumb_flow" img_type="flow" width="120" height="136" src="/backend/web/images/default.jpg">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="condition" id="condition" style="float:left;width:100%; height:300px; ;border:0;"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="attention" id="attention" style="float:left;width:100%; height:300px; ;border:0;"></textarea>
                                <script type="text/javascript">
