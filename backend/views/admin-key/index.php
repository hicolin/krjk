...
<th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" ><?=$modelLabel->getAttributeLabel("sex")?></th>
<th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" ><?=$modelLabel->getAttributeLabel("mobile")?></th>
<th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >具体地址</th>
                                ...
                                <tr id="rowid_$list->id">
                                    <td><label><input type="checkbox" value="<?=$list->id?>"></label></td>
                                                                                <td><?=$list['id']?></td>
                                                                                        ...
                                                                                        <td><?=$list['mobile']?></td>
                                                                                        <td><?=$list['province_name']?>&nbsp&nbsp<?=$list['city_name']?>&nbsp&nbsp<?=$list['area_name']?>&nbsp&nbsp<?=$list['address']?></td>
                                                                                <td class="center">
