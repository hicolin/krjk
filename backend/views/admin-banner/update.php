                ...
                <div class="box-body">
                    ...
                    <div class="tab-content">
                        ...
                        <!--<div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <?php /*echo $form->field($model, 'img')->textInput(["class" => "form-control", "placeholder" => $modelLabel->getAttributeLabel("img"), "id" => 'img']) */?>
                            </div>
                        </div>-->
                        <div class="form-group">
                            <label for="img"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <?php echo $form->field($model, 'link')->textInput(["class" => "form-control","value"=>PublicController::filter_decode($model->link), "placeholder" => $modelLabel->getAttributeLabel("link"), "id" => 'link']) ?>
                            </div>
                        </div>
                        <div class="clear"></div>
