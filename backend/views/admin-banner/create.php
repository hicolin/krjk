                    ...
                    <div class="tab-content">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-sm-8">
                                ...
                                <?php /*if(Yii::$app->session->hasFlash('info')) {echo '<p style="color:#dd4b39;display: block;margin-top:-10px;">图片格式不正确！</p>';}*/?>
                            </div>
                        </div>
                        <div class="clear"></div>
                       ...
                       <!-- <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <?php /*echo $form->field($model,'img')->fileInput(["class"=>"form-control","placeholder"=>$modelLabel->getAttributeLabel("img"),"id"=>'img','style'=>'border:none;']) */?>
                                <?php /*if(Yii::$app->session->hasFlash('info')) {echo '<p style="color:#dd4b39;display: block;margin-top:-10px;">图片格式不正确！</p>';}*/?>
                            </div>
                        </div>
                        <div class="clear"></div>-->
