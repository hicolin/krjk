                    ...
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <a id="create_btn" href="<?= Url::toRoute([$this->context->id . '/index']) ?>"
                               class="btn btn-xs btn-primary">admin-dai-records列表</a>
                        </div>
                    </div>
                </div>
                <!-- /.box-header -->
                ...
                <div class="box-body">
                    ...
                    <div class="tab-content">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <span class="form-control"><?=$model->member['nickname']?></span>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <span class="form-control"><?=$phone_system[$model->phone_system]?></span>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <span class="form-control"><?=date('Y-m-d H:i:s',$model->update_time)?></span>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
